...
A clean Django REST Framework backend application designed for customer management, product inventory tracking, and order placement with automatic stock quantity validation. Built for an interview round for a company in 2024, demonstrating core Django concepts, RESTful API design, and clean code standards.
